...
const GameVersion = {
    ...
    UPDATE_MESSAGES: {
        ...
        '0.6.1': '- Fixed a but where after starting a run solo you could no longer access the multiplayer menu. \n - Added seperate tracking for currency per player and currency earned in multiplayer is properly tracked and shared back to the client so when you play solo its still there. \n same was done for upgrades so each class will ahve its upgrades and you can use them in mutliplayer and solo.'
    }
};
