...
const GameVersion = {
    ...
    UPDATE_MESSAGES: {
        ...
        '0.6.1.1': '- Fixed bug that prevented single player instances from purchasing upgrades in the Nexus. (my bad, i really should have caught this before release of the multiplayer system)'
    }
};
