 ...
 */
const CACHE_VERSION = '0.9.1.13';  //havent written patch notes yet, but i know cache is 9.1.4 but the release wil be marked as 0.9.1 when i do write it
...
const PRECACHE_URLS = [
  ...
  './src/game/ui/components/companionRenderer.js',
  './src/game/ui/components/companionSync.js',
